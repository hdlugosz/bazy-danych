...
(2, 'Kazimiera', 'Socha', 'ul. Waryńskiego 1b', '508704262'),
(3, 'Celina', 'Sokołowska', NULL, NULL),
(4, 'Oksana', 'Wolska', 'ul. Witosa 6a', '552801976'),
(5, 'Brygida', 'Kozioł', 'ul. Konopnickiej 1', NULL),
(6, 'Bogusław', 'Konieczny', 'ul. Bema 5', '702001928'),
(7, 'Wioletta', 'Łukasik', 'ul. Obwodowa 136', '826491672'),
(8, 'Natalia', 'Pietrzak', 'ul. Robotnicza 172c', '684927722'),
(9, 'Arleta', 'Kaczmarczyk', 'ul. Bronowicka 12c', '725688200'),
(10, 'Zdzisław', 'Krupa', NULL, '649267399');
...
-- d) Wyświetl pracowników, których pierwsza litera imienia zaczyna się na literę ‘B’.

SELECT imie, nazwisko 
	FROM ksiegowosc.pracownicy
		WHERE imie LIKE 'B%'

-- e) Wyświetl pracowników, których nazwisko zawiera literę ‘o’ oraz imię kończy się na literę ‘a’.
...
-- g) Wyświetl imię i nazwisko pracowników, których pensja zawiera się w przedziale 3000 – 5000 PLN.
...
-- j) Uszereguj pracowników według pensji i premii malejąco. (Jesli byloby kilka takich samych kwot pensji, wtedy sortowaloby po wysokosci premii malejaco)
...
-- p) Usuń wszystkich pracowników mających pensję mniejszą niż 4000 zł.
